...
(* Usage
	...
	Option 2 : Run in a shell with wolframscript : "wolframscript -script 4concandidates-part1.wl x x x x x x", where x are the desired parameters of createGraphs.
*)
